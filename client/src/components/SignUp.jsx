        ...
        <div className='w-full max-w-md  lg:w-1/2'>
          ...
          >
            ...
            <div className='flex flex-col items-center justify-between mb-5'>
              ...
              <button className='flex items-center justify-center p-1 w-80 border shadow font-bold text-black  rounded-full hover:border-skin-border-google-hover mb-3 text-sm'>
                {' '}
                <img src={google} alt='' className=' w-10 h-10' />
                Continue with Google
              </button>
              <button className='flex items-center justify-center p-1 w-80 border shadow font-bold text-black  rounded-full hover:border-skin-border-google-hover text-sm  '>
                {' '}
