...
export default function Hero2() {
  return (
      <div id="landingpage" className="">
        ...
        <div className="container flex flex-col-reverse items-center px-6 pt-28 pb-20 mx-auto space-y-0 md:space-y-0 md:flex-row">
          {/* ---------------------------Middle Part-------------------------- */}
          <div className="flex flex-col space-y-8 md:w-1/2  lg:py-36">
            ...
            <div className="text-center">
              ...
              {/* ---------------Text Buddy--------------- */}
              <p className="text-lg font-bold my-6 text-gray-200">make diabetes your buddy</p>
              {/* ---------------Get Started Button--------------- */}
